...
namespace CheerMeApp.Contracts.V1
{
    public static class ApiRoutes
    {
        ...
        public static class Posts
        {
            ...
            public const string LikePost = Base + "/posts/{postId}/likes";
            public const string UnLikePost = Base + "/posts/{postId}/likes";
        ...
        public static class Comments
        {
            ...
            public const string LikeComment = CommentsBase + "/{commentId}/likes";
            public const string GetCommentLikes = CommentsBase + "/{commentId}/likes";
            public const string UnLikeComment = CommentsBase + "/{commentId}/likes";
            public const string ReplyComment = CommentsBase + "/{commentId}/replies";
